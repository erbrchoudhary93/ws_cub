...
lg_button = Button(st,text="Log-Out",font=("Time New Roman",20,"bold"),relief=RAISED,cursor="plus",command=logout_f)
lg_button.place(x=150,y=280,height=50,width=200)

st_button = Button(st,text="Shut-DOwn",font=("Time New Roman",20,"bold"),relief=RAISED,cursor="plus",command=shutdown_)
