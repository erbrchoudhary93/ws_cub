...
lab_down.place(x=60,y=200,height=50,width=380) # ram
...
button = Button(sp,text="Check Speed",font=("Time New Roman",30,"bold"),relief=RAISED,bg="red",command=speedcheak())
